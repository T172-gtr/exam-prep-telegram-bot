...
SAMPLE_TASKS = [
    ...
    dict(subject_lookup=("oge","math"), level="medium",
         ...
         body="Найдите площадь прямоугольника со сторонами 7 и 4 см.",
         answer="28 см²",
         hint="S = a × b"),
    dict(subject_lookup=("oge","math"), level="high",
         title="Квадратное уравнение",
         body="Решите уравнение: x² − 5x + 6 = 0",
         answer="x = 2, x = 3",
         hint="Разложите на множители или используйте дискриминант"),
    dict(subject_lookup=("oge","math"), level="max",
         title="Задача на движение",
         body="Два велосипедиста выехали навстречу друг другу из двух городов, расстояние между которыми 120 км. Скорость первого — 20 км/ч, второго — 25 км/ч. Через сколько часов они встретятся?",
         answer="2 ч 40 мин",
    ...
    dict(subject_lookup=("ege","math_p"), level="low",
         ...
         body="Найдите производную функции f(x) = x³.",
         answer="f'(x) = 3x²",
    ...
    dict(subject_lookup=("ege","math_p"), level="max",
         title="Интеграл",
         body="Вычислите интеграл ∫(3x² + 2x) dx.",
         answer="x³ + x² + C",
